...
internal static class CustomTimeOnlySerializerTestsData_Serialization
{
    internal static IEnumerable<object[]> ValidTimesData
    {
        get
        {
            return new[]
            {
                new object[] { new TimeOnlyWrapper(new TimeOnly(0)), "00:00:00.0000000" },
                new object[] { new TimeOnlyWrapper(new TimeOnly(0, 0)), "00:00:00.0000000" },
                new object[] { new TimeOnlyWrapper(new TimeOnly(0, 0, 0)), "00:00:00.0000000" },
                new object[] { new TimeOnlyWrapper(new TimeOnly(1, 0)), "01:00:00.0000000" },
                new object[] { new TimeOnlyWrapper(new TimeOnly(1, 0, 0)), "01:00:00.0000000" },
                new object[] { new TimeOnlyWrapper(new TimeOnly(0, 1)), "00:01:00.0000000"  },
                new object[] { new TimeOnlyWrapper(new TimeOnly(0, 1, 0)), "00:01:00.0000000"  },
                new object[] { new TimeOnlyWrapper(new TimeOnly(0, 0, 1)), "00:00:01.0000000"  },
                new object[] { new TimeOnlyWrapper(new TimeOnly(23, 59)), "23:59:00.0000000" },
                new object[] { new TimeOnlyWrapper(new TimeOnly(23, 59, 59)), "23:59:59.0000000" },
            };
        }
    }
}